/**
 * Amharic Translation Dictionary (የአማርኛ ቋንቋ መተርጎሚያ)
 */
export default {
  // Navigation
  nav: {
  ...
  features: {
    ...
    items: [
      {
        id: 'quality',
        title: 'እውነተኛ እና ጥራት ያላቸው እቃዎች',
        description: 'እያንዳንዱ ምርት በጥንቃቄ የተፈተሸና 100% ኦርጅናልነቱ የተረጋገጠ ነው፤ ከንጹህ የየመን ማር እስከ ዘመናዊ ኤሌክትሮኒክስ።'
      },
      {
        id: 'ordering',
        title: 'ቀላል የስልክ ትዕዛዝ',
        description: 'ውስብስብ መመዝገብ ሳያስፈልግዎት በአንድ ደቂቃ ውስጥ ይዘዙ። ስልክ ቁጥርዎን እና አድራሻዎን ብቻ ያስገቡ።'
      },
      {
        id: 'payments',
      ...
      {
        id: 'delivery',
        title: 'አስተማማኝ አድራሻ ማድረስ',
        description: 'በደሴ ከተማ ፈጣን የበር ለበር አድራሻ ማድረስ፣ እንዲሁም ወደ ሁሉም የደሴ ዙሪያዎች ፈጣን የመኪና ደሊቨሪ አገልግሎት።'
      }
    ]
  },
  ...
  products: {
    badge: 'የተመረጡ ምርቶች',
    title: 'ተወዳጅ እቃዎች',
    subtitle: 'ደንበኞቻችን የወደዷቸውን እና የተረጋገጡ ምርቶቻችን ከታች ይመልከቱ።',
    viewAll: 'ሁሉንም ምርቶች ይመልከቱ',
    inStock: 'ክምችት አለ',
    outOfStock: 'ለጊዜው አልቋል',
    outOfStockNotice: 'ይህ ምርት ለአሁን አልቋል ግን በቅርቡ ይመለሳል',
    currency: 'ብር',
    price: 'ዋጋ',
    orderNow: 'አሁን ይዘዙ',
    details: 'ዝርዝር ይመልከቱ',
    authenticTag: 'የተረጋገጠ ኦርጅናል',
    loading: 'ምርቶች እየተጫኑ ነው...',
    errorTitle: 'ምርቶችን መጫን አልተቻለም',
    errorDesc: 'ከሲስተሙ ጋር መገናኘት አልተቻለም። እባክዎ ጥቂት ቆይተው እንደገና ይሞክሩ።',
    retry: 'እንደገና ይሞክሩ',
    emptyTitle: 'በአሁኑ ሰዓት ምርት የለም',
    emptyDesc: 'አዳዲስ ምርቶች በቅርቡ ይገባሉ። እባክዎ ትንሽ ቆይተው ይመልከቱ።'
  },

  // How It Works
  howItWorks: {
    badge: 'ቀላል 3 ደረጃዎች',
    title: 'ትዕዛዝ እንዴት ማዘዝ ይችላሉ?',
    subtitle: 'ምንም አይነት ውስብስብ ሂደት የለም። በሶስት ቀላል እርምጃዎች የሚፈልጉትን እቃ ማግኘት ይችላሉ።',
    steps: [
      {
        number: '01',
        title: 'ምርትዎን ይምረጡ',
        description: 'ከዝርዝራችን ውስጥ የሚፈልጉትን ትክክለኛ እቃ ይምረጡ፤ ግልጽ እና ትክክለኛ ዋጋ በኢትዮጵያ ብር ተቀምጧል።'
      },
      {
        number: '02',
        title: 'መረጃዎን ያስገቡ',
      ...
      },
      {
        number: '03',
        title: 'እቃዎን ይቀበሉ',
        description: 'እቃዎ በአፋጣኝ ተዘጋጅቶ ይላክልዎታል። አድራሻዎ ድረስ ሲደርስ በደስታ ተቀብለው ይጠቀሙ።'
      }
    ]
  },
  ...
  // Footer
  footer: {
    tagline: 'ኦርጅናል የጤና፣ የውበት እና የኤሌክትሮኒክስ እቃዎችን በደሴ እና በመላው ኢትዮጵያ በቀጥታ አድራሻዎ ድረስ እናደርሳለን።',
    navigationTitle: 'ፈጣን ማገናኛዎች',
    customerCareTitle: 'የደንበኞች ድጋፍ',
    supportPhone: '+251 931 862 253',
    supportHours: 'ከሰኞ - ቅዳሜ፡ 2:00 ጠዋት - 2:00 ማታ',
    location: 'ደሴ፣ ኢትዮጵያ',
  ...
  notFound: {
    title: 'ገጹ አልተገኘም (404)',
    description: 'የፈለጉት ገጽ የለም ወይም ወደ ሌላ ቦታ ተዛውሯል።',
    backHome: 'ወደ ዋና ገጽ ይመለሱ'
  },

  productsPage: {
    title: 'የምርቶች ዝርዝር',
    subtitle: 'በአሁኑ ሰዓት የሚገኙ የተረጋገጡ እና ኦርጅናል ምርቶች ስብስብ።',
    backHome: 'ወደ ዋና ገጽ ይመለሱ'
  },
  ...
  orderModal: {
    title: 'ትዕዛዝዎን ያጠናቅቁ',
    subtitle: 'እባክዎ መረጃዎን ያስገቡ እና የክፍያ ዘዴ በመምረጥ ትዕዛዝዎን ያጠናቅቁ።',
    productLabel: 'የተመረጠው ምርት',
    quantity: 'ብዛት',
    customerInfo: 'የደንበኛ እና የማድረሻ መረጃ',
    fullName: 'ሙሉ ስም',
    fullNamePlaceholder: 'ለምሳሌ፡ አበበ ከበደ',
    phone: 'ስልክ ቁጥር',
    phonePlaceholder: 'ለምሳሌ፡ 912 345 678',
    onlyEthioNumbers: 'የኢትዮጵያ ስልክ ቁጥሮች ብቻ ይደገፋሉ።',
    phoneFormat: 'ቅርጸት: +2519 XX XXX XXX',
    address: 'ማድረሻ አድራሻ (ከተማ እና ሰፈር/መንደር)',
    addressPlaceholder: 'ለምሳሌ፦ ደሴ፣ ቧንቧ ውሃ (ወይም ከተማ እና ሰፈር)',
    addressHint: 'እባክዎ የከተማ ስም ብቻ ሳይሆን የተለየ ሰፈር ወይም መንደርዎን ይጥቀሱ (ለምሳሌ፦ ደሴ፣ ቧንቧ ውሃ)።',
    cityVillageArea: 'ከተማ እና ሰፈር',
    ...
    paymentFailedDesc: 'ትዕዛዝዎ ተፈጥሯል፤ ነገር ግን የክፍያ መረጃውን ማስተላለፍ አልተቻለም።',
    retryPayment: 'ክፍያውን እንደገና ላክ'
  },

  // My Orders / Order History
  myOrders: {
    title: 'የእኔ ትዕዛዞች',
    subtitle: 'ቀደም ሲል ያዘዟቸው ትዕዛዞች',
    emptyTitle: 'እስካሁን ምንም ትዕዛዝ የለም',
    emptyDesc: 'ትዕዛዝ ሲያዙ የትዕዛዝ ታሪክዎ እዚህ ይታያል።',
    orderNumber: 'የትዕዛዝ ቁጥር',
    orderDate: 'የታዘዘበት ቀን',
    ...
    close: 'ዝጋ',
    items: 'የታዘዙ እቃዎች',
    loading: 'የትዕዛዝ መረጃ በመጫን ላይ...',
    refresh: 'አድስ',
    rejectionReason: 'ያልተረጋገጠበት ምክንያት',
    statuses: {
      pending: 'በመጠባበቅ ላይ',
      payment_review: 'ክፍያ በግምገማ ላይ',
      confirmed: 'ተረጋግጧል',
  ...
  maintenance: {
    badge: 'ጊዜያዊ የመደብር ማሻሻያ',
    title: 'አዲስና የተሻለ አገልግሎት እያዘጋጀንልዎ ነው',
    subtitle: 'የመደብር ስርዓታችንን ይበልጥ ለማዘመንና ፈጣን ለማድረግ በጊዜያዊ ማሻሻያ ላይ እንገኛለን። በቅርቡ ተመልሰን እንገናኛለን!',
    backSoon: 'በቅርቡ እንመለሳለን',
    statusBadge: 'የስርዓት ማሻሻያ በመከናወን ላይ',
    reassuranceTitle: 'ቀደም ሲል ያዘዙት ትዕዛዝ አለዎት?',
    reassuranceDesc: 'አይጨነቁ! ቀደም ሲል የተረጋገጡ ትዕዛዞች እና ማድረሻዎች በቡድናችን ያለ ምንም መስተጓጎል በመዘጋጀትና በመላክ ላይ ይገኛሉ።',
    supportTitle: 'አስቸኳይ ድጋፍ ወይም ጥያቄ አለዎት?',
    supportSubtitle: 'የደሴ የደንበኞች አገልግሎት ቡድናችን በቀጥታ ሊያግዝዎት ዝግጁ ነው።',
    phoneLabel: 'በስልክ ይደውሉ',
    phoneValue: '+251 931 862 253',
    hoursLabel: 'የስራ ሰዓት',
    hoursValue: 'ከሰኞ – ቅዳሜ፡ 2:00 ጠዋት – 2:00 ማታ',
    locationLabel: 'አድራሻ',
    locationValue: 'ደሴ፣ ኢትዮጵያ',
